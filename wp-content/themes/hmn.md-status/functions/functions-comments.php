<?php
if ( ! function_exists( 'pte_comment' ) ) :
function pte_comment( $comment, $args, $depth ) {
...
function pte_coment_form_fields( $fields ) {
...
add_filter('comment_form_default_fields','pte_coment_form_fields' );

function pte_coment_form_modifications( $defaults ) {
    $defaults['comment_notes_after'] = ' ';
    return $defaults;
}
add_filter( 'comment_form_defaults', 'pte_coment_form_modifications' );
